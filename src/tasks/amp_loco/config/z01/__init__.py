...
from .env_cfgs import (
  ...
  z01_amp_flat_warmup_env_cfg,
  z01_amp_rough_env_cfg,
)
from .rl_cfg import (
  z01_amp_ppo_runner_cfg,
  z01_amp_ppo_warmup_runner_cfg,
)

register_mjlab_task(
  task_id="Z01-AMP-Flat-Warmup",
  env_cfg=z01_amp_flat_warmup_env_cfg(),
  play_env_cfg=z01_amp_flat_warmup_env_cfg(play=True),
  rl_cfg=z01_amp_ppo_warmup_runner_cfg(),
